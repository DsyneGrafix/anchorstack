...
import { Home, Clock, FileText, Settings, Anchor, Play, Pause, RotateCcw, Plus, Search, Calendar, RefreshCw, ExternalLink } from 'lucide-react';
...
const useTimerStore = () => {
  ...
  return { timeLeft, isRunning, mode, start, pause, reset };
};
...
const VaultTile: React.FC<{ product: VaultProduct }> = ({ product }) => {
  const tierColors = {
